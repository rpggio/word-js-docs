...
This sample shows how to perform operations on comments (including insert, reply, get, edit, resolve, and delete) and use comment events.

This sample shows operations on comments and how to use comment events.

    **Important**: Comment events APIs are currently in preview. If this snippet doesn't work, try using
        Word
